...
public class OldCpu {
    ...
    private OldRegisteredFile registerFile = new OldRegisteredFile();
    private Memory memory; // Se asigna en el constructor
    private OldBus bus = new OldBus();
    private InterruptManager interruptManager = new InterruptManager();
    private OldAddressingMode addressingMode; // Se asigna en el constructor
    ...
    public OldCpu(Memory mem, OldAddressingMode addrMode, List<IODevice> devices, List<String> initialInstructions) {
        this.memory = mem;
    ...
    public OldRegisteredFile getRegisterFile() {
